  ...
  return (
    <div>
      ...
      <section className="relative h-[60vh] min-h-[400px] flex items-end">
        ...
        <div className="relative container-brand section-padding pb-16 z-10">
          <motion.h1
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="font-heading text-5xl md:text-7xl lg:text-8xl text-iron-foreground uppercase leading-none"
          >
            Cobertura
          </motion.h1>
          <motion.p
            ...
            className="font-heading text-xl md:text-2xl text-iron-foreground/90 mt-4 max-w-xl uppercase"
          >
            Presencia nacional, servicio local
          </motion.p>
        </div>
      </section>
